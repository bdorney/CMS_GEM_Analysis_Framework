...
do
	if [[ ${argList[1]} == *"#"* ]]; then
		...
		echo "with command:"
		echo ""
		echo python2.7 $GEM_BASE/python/computeGainMap.py --file=${argList[1]} --gp0=${argList[2]} --gp0Err=${argList[3]} --gp1=${argList[4]} --gp1Err=${argList[5]} --name=${argList[6]} --hvPoint=${argList[7]} --hvlist=${argList[8]}
		echo ""
		python2.7 $GEM_BASE/python/computeGainMap.py --file=${argList[1]} --gp0=${argList[2]} --gp0Err=${argList[3]} --gp1=${argList[4]} --gp1Err=${argList[5]} --name=${argList[6]} --hvPoint=${argList[7]} --hvlist=${argList[8]}
		echo ""
		echo ""
		echo "================="
