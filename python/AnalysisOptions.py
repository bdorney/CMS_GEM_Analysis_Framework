...
#debugging
parser.add_option("-debug","--deubg", type="int", dest="debug",
...
#gain parameters
parser.add_option("-gp0", "--gainP0", type="float", dest="gain_P0",
                  help="P0 in G(x)=exp(P0*X+P1)", metavar="gain_P0")
parser.add_option("-gp0Err", "--gainP0Err", type="float", dest="gain_P0_Err",
                  help="Error on P0 in G(x)=exp(P0*X+P1)", metavar="gain_P0_Err")
parser.add_option("-gp1", "--gainP1", type="float", dest="gain_P1",
                  help="P1 in G(x)=exp(P0*X+P1)", metavar="gain_P1")
parser.add_option("-gp1Err", "--gainP1Err", type="float", dest="gain_P1_Err",
