...
parser.add_argument('--YaxisScale',action="store_true",default=False,help="If YaxisScale option is used the Y axis is plotted in kUnit. Default is: False")
parser.add_argument('--SetErrX',action="store_true",default=False,help="Set Error option true (for X axis) ")
parser.add_argument('--SetErrY',action="store_true",default=False,help="Set Error option true (for Y axis)")
...
parser.add_argument('--Fit',default=False,action='store_true',help="if it is used the header parameters for the fit are created")
