...
parser.add_option('--CanvTitleX',action="store",dest="CanvTitleX",type=str,default="Divider Current #left(#muA#right)",help="Set Xaxis title, example: Divider Current #left(#muA#right)")
