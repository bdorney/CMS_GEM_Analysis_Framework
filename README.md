...
=================
   ...
   * [3. Usage](#3-usage)
      ...
      * [3.b. genericPlotter](#3b-genericplotter)
         ...
         * [3.b.ii.I Helper Script - Parsing Excel Files to genericPlotter](#3biii--helper---parsing-excel-files-to-genericPlotter)
         * [3.b.ii.II Helper Script - Parsing Excel Files to genericPlotter-Additional Scripts](#3biiii--helper---parsing-excel-files-to-genericPlotter--additional-scripts)
   ...
   * [4. Documentation](#4-documentation)
      ...
      * [4.f. Output File - Analysis Mode](#4f-output-file---analysis-mode)
         ...
         * [4.f.vi Output ROOT File - Efficiency Map](#4fvi-output-root-file---efficiency-map)
