...
# Define source files
SOURCES = src/DetectorMPGD.cpp src/ParameterLoaderAmoreSRS.cpp src/ParameterLoaderAnaysis.cpp src/UniformityUtilityFunctions.cpp src/TimingUtilityFunctions.cpp src/analyzeUniformity.cpp 
