...
# Define source files
SOURCES = src/DetectorMPGD.cpp src/ParameterLoaderAmoreSRS.cpp src/UniformityUtilityFunctions.cpp src/TimingUtilityFunctions.cpp src/analyzeUniformity.cpp 
