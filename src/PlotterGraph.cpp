...
void PlotterGraph::drawPlots(){
    ...
    mgraph_Obs->GetXaxis()->SetRangeUser(m_canvInfo.m_fXAxis_Min, plotInfo.m_fXAxis_Max);
    
    mgraph_Obs->GetYaxis()->SetTitle(m_canvInfo.m_strTitle_Y.c_str() );
    mgraph_Obs->GetYaxis()->SetRangeUser(m_canvInfo.m_fYAxis_Min, plotInfo.m_fYAxis_Max);
