...
int main( int argc_, char * argv_[] ){
    ...
    myVisualizer.storeCanvasGraph(vec_strInputArgs[4], "UPDATE", "ResponseFitChi2", "E1", true);
    myVisualizer.storeCanvasGraph(vec_strInputArgs[4], "UPDATE", "ResponseFitPkPos", "E1", true);
